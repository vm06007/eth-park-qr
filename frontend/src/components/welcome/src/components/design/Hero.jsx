...
export const Gradient = () => {
  return (
    <div className="absolute top-0 -left-[0rem] w-[56.625rem] h-[56.625rem] opacity-50 mix-blend-color-dodge pointer-events-none">
      <img
    ...
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        ...
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[56deg]">
          ...
          >
            <img style={{transform: "scale(3.5) rotate(55deg)"}} src="https://wiselending.com/images/tokens/wsteth.svg"></img>
          </div>
        </div>

        <div className="hidden absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[54deg]">
          <div
        ...
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[65deg]">
          <div
            className={`hidden w-3 h-3 -ml-1.5 mt-52 bg-gradient-to-b from-[#B9AEDF] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[85deg]">
          ...
          >
            <img style={{transform: "scale(2.5) rotate(85deg)"}} src="https://wiselending.com/images/tokens/dai.svg"></img>
          </div>
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[70deg]">
          ...
          >
            <img style={{transform: "scale(2.5) rotate(-70deg)"}} src="https://wiselending.com/images/tokens/eth.svg"></img>
          </div>
        </div>
      </MouseParallax>
    </div>
